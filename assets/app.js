 ...
 var timeBegan = null, 
  ...
  function clockRunning(){
    var currentTime = new Date(), timeElapsed = new Date(currentTime - timeBegan - stoppedDuration),
    ...
    $(document).ready(function(){
      ...
      //Moving button, counting taps
  
  var valueCon = document.getElementById("counterText");
